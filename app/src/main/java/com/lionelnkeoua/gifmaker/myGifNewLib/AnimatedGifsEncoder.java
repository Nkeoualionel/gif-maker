package com.lionelnkeoua.gifmaker.myGifNewLib;

/**
 * Created by Chirag on 23-02-2018.
 */
...
/**
 * Class AnimatedGifsEncoder - Encodes a GIF file consisting of one or more
 * frames.
 *
 * <pre>
 *  Example:
 *     AnimatedGifsEncoder e = new AnimatedGifsEncoder();
 ...
 * the associated LZWEncoders class. Please forward any corrections to
 * kweiner@fmsware.com.
 *
...
public class AnimatedGifsEncoder {
    private static final String TAG = "AnimatedGifsEncoder";
    ...
    private void writePixels() throws IOException {
        LZWEncoders encoder = new LZWEncoders(width, height, indexedPixels, colorDepth);
        encoder.encode(out);
    }
